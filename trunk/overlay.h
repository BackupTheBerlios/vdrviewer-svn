...
extern int GetStringLen(const char *string);

extern void RenderString(const char *string, int sx, int sy, int maxwidth, int layout, int color, int bgcolor);
extern void RenderBox(int sx, int sy, int ex, int ey, int mode, int color);
extern void RenderCircle(int sx, int sy, char type);

extern Pixel ConvertColor(CARD32 origcolor);
